...
async function sendOrderConfirmation(order, items, downloadUrl) {
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a0a0f;color:#e8e8ed;padding:32px;border-radius:12px;">
      ...
      <a href="${downloadUrl}" style="display:inline-block;background:#0052FF;color:#fff;padding:14px 28px;border-radius:8px;text-decoration:none;font-weight:600;margin:16px 0;">Descargar archivos</a>
